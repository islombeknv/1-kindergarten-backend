...
from posts.models import StaffModel, GalleryModel, NewsModel, BannerModel, ContactModel
...
class BannerModelAdmin(ImageCroppingMixin, admin.ModelAdmin):
    list_display = ['text', 'created_at']
    list_filter = ['created_at']
    search_fields = ['text']
...
class ContactModelAdmin(ImageCroppingMixin, admin.ModelAdmin):
